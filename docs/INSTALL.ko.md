...
4. 설치 후 자동으로 열린 앱에서 **환경 설정 → 언어**를 선택하고 한국어 또는 English를 고릅니다.
5. **모니터 배치**를 선택한 뒤 **바탕화면에 적용**을 누릅니다.
...
기본 물고기 표현은 **3D 네온테트라**입니다. 환경 설정에서 **기존 모드**로 바꿀 수 있습니다. 언어·물고기 표현과 나머지 설정은 자동으로 저장됩니다.
