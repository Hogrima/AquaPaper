...
**v1.5.0:** 환경 설정 → 수조에서 **강가의 숲 · 입체** 또는 **열대 산호 수조**를 선택할 수 있습니다. 강가의 숲은 좌측의 긴 잎과 우측의 낮은 넓은 잎이 서로 다른 물 흐름으로 움직입니다. 산호 수조는 먼 암초·협곡 4장을 포함한 독립 이미지 10장과 Blender 물고기 5종(흰동가리·노란양쥐돔·블루탱·무어리시 아이돌·난쟁이매)을 사용합니다. [강가의 숲 안내](docs/LAYERED-BACKGROUNDS.md) · [산호 수조 안내](docs/TROPICAL-REEF.md)
